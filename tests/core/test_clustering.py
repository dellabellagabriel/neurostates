...
from neurostates.core.clustering import Concatenator, sort_centroids_by_entropy
...
def test_sort_by_entropy():
    ...
    sorted_indices, _ = sort_centroids_by_entropy(centroids)

    assert sorted_indices[0] == 2
    assert sorted_indices[1] == 0
    assert sorted_indices[2] == 1
